...
import { CORS_HEADERS, allowBeacon, isBot, isValidVid, readBeacon, recordPing, resolveProjectId } from '@/lib/track';

export const dynamic = 'force-dynamic';

/** heartbeat from rba.js every 30 seconds while the tab is visible: { project, vid }. */
export async function POST(req: NextRequest) {
  ...
  try {
    ...
    console.error('track: failed to record ping', error);
  }
